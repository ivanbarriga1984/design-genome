...
export function CreationMoment({onReveal,onComplete}:{onReveal:()=>void;onComplete:()=>void}){
  ...
  useEffect(()=>{
    ...
    const timers=[setTimeout(()=>setPhase(1),900),setTimeout(()=>setPhase(2),1800),setTimeout(onReveal,2250),setTimeout(onComplete,3000)];
