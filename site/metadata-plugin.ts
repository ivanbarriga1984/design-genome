...
export function publicMetadata(): Plugin {
  ...
  return {
    ...
    async closeBundle() {
      ...
      const pages = new Map<string, string | undefined>([["/framework", undefined], ["/build", undefined], ["/reference", "Overview — Forma Reference — Design Genome"], ["/reference/machine-context", "Machine context — Forma Reference — Design Genome"]]);
