...
export default function Build() {
  ...
  return <article className="build-page">
    ...
    <aside className="build-gene-entry dg-wrap"><div><span className="build-label">Start with one decision</span><p>Turn one recurring design decision into portable organizational knowledge with a guided, browser-only exercise.</p></div><Link className="dg-text-link" to="/build/gene">Build your first Gene<Icon /></Link></aside>
